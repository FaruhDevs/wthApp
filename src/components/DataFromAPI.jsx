  ...
  return (
    <div className=' '>
      {selectedCity ? 
        ...
        <p className=' max-w-[400px] sm:max-w-[1000px] sm:px-3 text-center font-medium text-slate-300 text-sm md:text-lg'>Explore current weather data and 6-day forecast of more than 200,000 cities!</p>  
          </div>)}
    </div>
